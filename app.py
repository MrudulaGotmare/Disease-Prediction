...
with st.sidebar:
    selected = option_menu('Multiple Disease Prediction', [
        ...
        icons=['','file-text','activity', 'heart', 'person','person','person'],
        default_index=0)
...
if selected == 'Report Summary':
    ...
    input_text = st.text_input("Input Query: ", key="input")
    ...
    input_prompt = """
                   ...
                   You will receive input images as medical reports &
